...
//The account numbers to login in the categories are 50 for Staff, 05 for teacher and
                    ...
                    for (int i=0 ; i<=9 ; i++)
                    {
                        if(books[i].getTitle()==getSearch())
                        {
                            for (int j=0 ; j<=4 ; j++)
                            {
                                ...
                                {
                                    if(students[j].getAccount_Number()==books[i].getAccountNum())
                                    {
                            ...
                            if(check_three==false)
                                cout<<"Book not found on User's account"<<endl;
                            check_two=true;
                        }
                    }
                    if(check_two==false)
                    ...
                    for (int i=0 ; i<=9 ; i++)
                    {
                        if(books[i].getTitle()==getSearch())
                        {
                            for (int j=0 ; j<=4 ; j++)
                            {
                                ...
                                {
                                    if(teachers[j].getAccount_Number()==books[i].getAccountNum())
                                    {
                    ...
                    for (int i=0 ; i<=9 ; i++)
                    {
                        if(books[i].getTitle()==getSearch())
                        {
                            for (int j=0 ; j<=4 ; j++)
                            {
                                ...
                                {
                                    if(staffs[j].getAccount_Number()==books[i].getAccountNum())
                                    {
                                        books[i].Return_Date.increment_date(7);
                                        cout<<"Book reissued successfully!"<<endl;
                                        check_three=true;
    ...
    void Issued_Book_Of_Users(int n, unsigned int an)
    {
        ...
        switch (n)
        {
            case 1:
            {
                ...
                if(check_one==false)
                    cout<<"No issued books found on this account"<<endl;
                break;
            }
            case 2:
            {
...
int main()
{
    ...
    Teacher tea_one ("Usman_Ali", 05, 0,0); //05 is the account number
    Teacher tea_two ("Rabia_Basri", 06, 0,0);
